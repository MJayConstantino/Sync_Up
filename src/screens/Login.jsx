...
// import { View, Text, TouchableOpacity, TextInput, StyleSheet, Image, ScrollView, Alert, BackHandler } from 'react-native';
...
//         React.useCallback(() => {
//             const onBackPress = () => {
//                 // Prevent back navigation to the splash screen
...
//             <Image source={require('../assets/SyncUp Logo.png')} style={{ width: 200, height: 200, marginBottom: 20 }} />
//             <Text style={{ fontWeight: 'bold', fontSize: 40, textAlign: 'center', fontFamily: 'normal'}}>
...
//             </TouchableOpacity>
//             <TouchableOpacity onPress={() => forgetPassword(email)} style={{ marginTop: 20 }}>
